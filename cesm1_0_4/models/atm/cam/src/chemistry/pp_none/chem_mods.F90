...
!--------------------------------------------------------------
      ...
      integer, parameter :: hetcnt = 0, & ! number of heterogeneous processes
                            phtcnt = 0, & ! number of photolysis reactions
                            rxntot = 0, & ! number of total reactions
                            gascnt = 0, & ! number of gas phase reactions
                            nabscol = 2, & ! number of absorbing column densities
                            gas_pcnst = 0, & ! number of "gas phase" species
                            nfs = 1, & ! number of "fixed" species
                            relcnt = 0, & ! number of relationship species
                            grpcnt = 0, & ! number of group members
                            nzcnt = 0, & ! number of non-zero matrix entries
                            ...
                            clscnt4 = 0, & ! number of species in implicit class
